...
public class EarthBlastFurnaceScreenHandler extends ScreenHandler {
    private final Inventory inventory;
    private final PropertyDelegate propertyDelegate;
    public EarthBlastFurnaceScreenHandler(int synId, PlayerInventory inventory){
        this(synId, inventory, new SimpleInventory(5),new ArrayPropertyDelegate(4));
    }
    public EarthBlastFurnaceScreenHandler(int synId, PlayerInventory playerInventory, Inventory inventory, PropertyDelegate delegate){
