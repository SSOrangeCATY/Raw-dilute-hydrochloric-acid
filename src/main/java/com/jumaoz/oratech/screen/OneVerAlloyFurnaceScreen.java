...
public class OneVerAlloyFurnaceScreen extends HandledScreen<OneVerAlloyFurnaceScreenHandler> {
    private static final Identifier TEXTURE = new Identifier("oratech","textures/gui/1V_alloy_furnace.png");
    public OneVerAlloyFurnaceScreen(OneVerAlloyFurnaceScreenHandler handler, PlayerInventory inventory, Text title) {
