...
public class Amiya extends CharacterGen {
    public Amiya(String[][] arkData, int number, CharacterIdentifier identifier) {
        ...
        this.simpleSkillInfo = "技能开启时获得力量与抗性提升,攻击变为二连击";
        this.skillInfo = new String[]{"手动开启,"+triggerTime/20+"sp"+"持续时间30s,技能开启时获得力量I与抗性提升II","技能开启时,你的攻击伤害类型变为真实且攻击敌方将造成双倍伤害","当与陈同时在场时技能将会被替换"};
    }
    @Override
